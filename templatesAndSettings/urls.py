...
urlpatterns = [re_path(r'^' + '', admin.site.urls),
               ...
               re_path(r'^' + 'soilsscatterplot.html', views.scatter_plot,
                   name="scatter_plot"),
               re_path(r'^' + 'wsscatterplot.html', views.water_sample_scatter_plot,
                       name="scatter_plot"),
               re_path(r'^' + 'wsscatterplottime.html', views.water_sample_scatter_plot_time,
                       name="scatter_plot_time"),
