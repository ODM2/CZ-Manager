...
ADMIN_SHORTCUTS = [
    {
        ...
        'shortcuts': [
            ...
            {
                'url': '/'+URL_PATH+URL_PATH+  'AddSensor.html',
                'app_name': '{}'.format(app_name),
                'title': 'Add Sensor Data',
                'class': 'tool',
            },
            {
                'url': '/'+URL_PATH+URL_PATH+ 'AddProfile.html',
                 'app_name': '{}'.format(app_name),
                'title': 'Add Soil Profile Data',
                'class': 'flag',
            },
            {
                'url': '/'+URL_PATH+URL_PATH+  'RecordAction.html',
                'app_name': '{}'.format(app_name),
                'title': 'Record an Action',
                'class': 'notepad',
            },
             {
                'url': '/'+URL_PATH+URL_PATH+ 'ManageCitations.html',
                'app_name': '{}'.format(app_name),
                'title': 'Manage Citations',
                'class': 'pencil',
            },
            {
                'url': '/'+URL_PATH+URL_PATH+ 'chartIndex.html',
                'app_name': '{}'.format(app_name),
                'title': 'Graph My Data',
                'class': 'monitor',
            },
