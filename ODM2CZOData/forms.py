...
class SamplingfeaturesAdminForm(ModelForm):
    class Meta:
        ...
        fields = ['sampling_feature_type', 'samplingfeaturecode', 'samplingfeaturename',
                  'samplingfeaturedescription', 'sampling_feature_geo_type', 'featuregeometry', 'featuregeometry',
    ...
    featuregeometry = forms.CharField(help_text="feature geometry (to add a point format is POINT(lat, lon)" +
    ...
    featuregeometry = forms.CharField(label='Featuregeometry',
                                          widget=forms.Textarea, required=False)
