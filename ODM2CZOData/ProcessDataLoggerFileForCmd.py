...
def process_datalogger_file(f,fileid, databeginson,columnheaderson):
    ...
    databeginson = int(databeginson[0])
    columnheaderson= int(columnheaderson[0])
    try:
...
parser.add_argument('databeginson', nargs=1)
parser.add_argument('columnheaderson', nargs=1)
args = parser.parse_args()
process_datalogger_file(args.dataloggerfilelink,args.dataloggerfileid,args.databeginson,args.columnheaderson)