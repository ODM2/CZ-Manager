...
class ProcessDataloggerfile(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        filelink = self.dataloggerfileid.dataloggerfilelink.path
        #dataloggerfile = self.dataloggerfileid.dataloggerfileid
        management.call_command('ProcessDataLoggerFile',filelink,self.dataloggerfileid.dataloggerfileid, self.databeginson, self.columnheaderson, False, False)
