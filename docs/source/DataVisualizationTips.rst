...
* We looked at a timeseries with the following link: https://odm2admin.cuahsi.org/Sandbox/graphfa/samplingfeature=776/resultidu=16657/popup=Anno/
...
* enddate=2016-07-10
* https://odm2admin.cuahsi.org/Sandbox/graphfa/samplingfeature=776/resultidu=16657/startdate=2016-07-08/enddate=2016-07-10/popup=Anno/

We can also change the time series with the resultidu URL parameter to select conductivity set it like:

* resultidu=14
* https://odm2admin.cuahsi.org/Sandbox/graphfa/samplingfeature=776/resultidu=14/startdate=2016-07-08/enddate=2016-07-10/popup=Anno/


Based on the URL we can see that the sampling feature used here has an id of 776:

Which is here: https://odm2admin.cuahsi.org/Sandbox/odm2admin/samplingfeatures/776/change/

We could also find the site by searching for Rio Espritu Santo Stream House in the sampling features search page:

https://odm2admin.cuahsi.org/Sandbox/odm2admin/samplingfeatures/?q=Rio+Espiritu+Santo+Stream+House

Similarly we can find the data result and associated time series result with id 16657:

https://odm2admin.cuahsi.org/Sandbox/odm2admin/results/16657/change/

or we can search for Rio Espiritu Santo Stream House Water Temperature

https://odm2admin.cuahsi.org/Sandbox/odm2admin/results/?q=Rio+Espiritu+Santo+Stream+House+Water+Temperature
