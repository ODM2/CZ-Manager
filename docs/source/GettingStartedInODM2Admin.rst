Getting Started With ODM2 Admin
==========

ODM2 Admin is intended for site level management of environmental data stored in ODM2 Admin.
It can be used for new or existing sites. It provides graphing and mapping functions for time
series and sample based data and is part of a larger suite of software developed to support ODM2.
