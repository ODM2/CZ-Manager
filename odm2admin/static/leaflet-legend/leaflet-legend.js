L.Control.Legend = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this._map = map;
        this._filterbutton = L.DomUtil.get("close-filter");
    ...
    _initToggle: function() {
        ...
        if (this.options.collapsed) {
            ...
            if (!L.Browser.android) {
                L.DomEvent
                    .on(container, 'mouseclick', this._expand, this);
                    //.on(button, 'mousedclick', this._collapse, this);
            }
            ...
            L.DomEvent.on(filter, 'click', this._collapse, this);
