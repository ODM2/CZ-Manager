...
ODM2 Sandbox you can navigate to https://odm2admin.cuahsi.org/Sandbox/odm2admin/dataloggerfiles/

.. image:: /images/DataLoggerFiles.png

#. Select the first data logger file ending in QP_DO
   https://odm2admin.cuahsi.org/Sandbox/odm2admin/dataloggerfiles/133/change/
...
#. The Data result contains much of the information about how our time series is configured. Go to the data results page
   (https://odm2admin.cuahsi.org/Sandbox/odm2admin/results/) to find our result. If we search for Prieta, the name
...
#. Now select the data result, with the variable DO Concentration and ID 21
   (https://odm2admin.cuahsi.org/Sandbox/odm2admin/results/21/change/).
