...
#variable= modelHelpers.searchModelColumnFor(" P ",Variables,'variablecode') #74
variableDBID = 74
print(variableDBID)
unit=modelHelpers.searchModelColumnFor(" milligrams per kilogram ",Units,'unitsname')#36 'unitsabbreviation'
...
variable= modelHelpers.searchModelColumnFor(" sodium bicarbonate extractable phosphorus ",Variables,'variablecode') #74
...
variable= modelHelpers.searchModelColumnFor(" NaOH extractable Phosphorus ",Variables,'variablecode') #74
variableDBID = variable.variableid
print(variableDBID)
unit=modelHelpers.searchModelColumnFor(" milligrams per kilogram ",Units,'unitsname')#36 'unitsabbreviation'
variableUnitID = unit.unitsid
...
variable= modelHelpers.searchModelColumnFor(" pH, Soil ",Variables,'variablecode') #74
variableDBID = variable.variableid
print(variableDBID)
unit= Units.objects.get(unitsid=7)#modelHelpers.searchModelColumnFor(" pH ",Units,'unitsname')#36 'unitsabbreviation'
variableUnitID = unit.unitsid
print(variableUnitID)
actionID=27
act = Actions.objects.filter(actionid=actionID).get()
